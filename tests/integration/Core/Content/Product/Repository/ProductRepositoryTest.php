...
class ProductRepositoryTest extends TestCase
{
    ...
    public function testWritePrice(): void
    {
        ...
        $product = $this->repository->search(new Criteria([$id]), $this->context)->getEntities()->get($id);
    ...
    public function testVariantNameIsNullable(): void
    {
        ...
        $variant = $this->repository->search(new Criteria([$variantId]), $this->context)->getEntities()->first();
    ...
    public function testUpdatedProductChildCountOnVariantDeletion(): void
    {
        ...
        $product = $this->repository->search(new Criteria([$parentId]), $this->context)->getEntities()->first();
        static::assertNotNull($product);
    ...
    public function testProductPricesSortByGrossPrice(): void
    {
        ...
        $firstPrice = $price->getPrice()->first();
        static::assertNotNull($firstPrice);
        static::assertSame(10.0, $firstPrice->getGross());
        static::assertSame(8.0, $firstPrice->getNet());
    }
    ...
    public function testProductPricesSortByNetPrice(): void
    {
        ...
        $firstPrice = $price->getPrice()->first();
        static::assertNotNull($firstPrice);
        static::assertSame(19.0, $firstPrice->getGross());
        static::assertSame(8.0, $firstPrice->getNet());
    }
    ...
    public function testProductMediaAssociationWithSortingAndPagination(): void
    {
        ...
        $product = $this->repository->search($criteria, Context::createDefaultContext())->getEntities()->first();
        static::assertNotNull($product);
    ...
    public function testWriteProductOverCategories(): void
    {
        ...
        $products = $this->repository->search(new Criteria([$productId]), Context::createDefaultContext())->getEntities();
    ...
    public function testCreateAndAssignProductProperty(): void
    {
        ...
        $product = $this->repository->search($criteria, Context::createDefaultContext())->getEntities()->get($id);
        static::assertNotNull($product);
    ...
    public function testCreateAndAssignCMSPage(): void
    {
        ...
        static::assertSame('product_detail', $cmsPage->getType());
    }
    ...
    public function testChildren(): void
    {
        ...
        static::assertInstanceOf(ProductConfiguratorSettingCollection::class, $product->getConfiguratorSettings());
        static::assertCount(3, $product->getConfiguratorSettings());
    }
